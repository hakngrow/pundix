...
contract HowieToken is Ownable, ERC20 {
     ...
     */
    function transferTo(address recipient_, uint256 amount) public virtual onlyOwner returns (bool) {
    ...
    /**
     * @dev Destroys tokens sent to the contract, reducing the total supply.
     *
     * Emits a {Transfer} event with `to` set to the zero address.
     */
    
    function burn() payable public virtual {
